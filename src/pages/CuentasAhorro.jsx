...
const CuentasAhorro = () => {
  ...
  return (
    <div className="container mx-auto py-10 max-w-xl">
      ...
      <Link to="/solicitud-online" className="inline-block bg-coop-green text-white px-6 py-2 rounded hover:bg-coop-blue hover:text-white transition mb-8">Solicitar este producto</Link>
    </div>
  );
};
